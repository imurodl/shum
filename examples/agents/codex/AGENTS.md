...
You have access to `shum`, a CLI for safe Docker Compose upgrades on remote SSH hosts. The full agent contract lives at the repo root in [`AGENTS.md`](../../../AGENTS.md). Read it first.
